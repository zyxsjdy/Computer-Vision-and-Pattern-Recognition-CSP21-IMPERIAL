...
image = imrotate(imread('FD1.jpg'),0);   %don't change the figure 
%% 
L = 0;      % number of pixels to be added around the image
ED = 0.8;   % Edge Threshold
ML = 30;    % MinLength of HoughPeaks
%%
...
yline(830, '-', 'LineWidth', 3, 'Color', 'blue'); hold on;
plot(654.8, 830.6, 'Marker','o','MarkerSize',10, 'MarkerFaceColor','r')